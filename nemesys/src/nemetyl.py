...
def evaluate_clustering(true_labels, predicted_labels, beta=0.4):
    ...
    # 计算 Homogeneity, Completeness and V-Measure
...
if __name__ == '__main__':
    ...
    _, ext = os.path.splitext(args.pcapfilename)
    ext = ext.lower()
    if ext == '.csv':
        true_labels = []   
        with open(args.pcapfilename, mode='r', newline='') as file:
    ...
    h,c,v = evaluate_clustering(true_labels, tyl.labels)
