...
from nemere.utils.loader import SpecimenLoader, CSVSpecimenLoader
...
class CachedDistances(object):
    ...
    def _calc(self):
        ...
        def determine_file_type(filename):
            ...
            ext = ext.lower()  # Convert extension to lowercase for case-insensitive comparison
        ...
        if determine_file_type(self.pcapfilename) == "pcap":
            self.specimens = SpecimenLoader(self.pcapfilename, self.layer, relativeToIP=self.relativeToIP)
        elif determine_file_type(self.pcapfilename) == "csv":
            self.specimens = CSVSpecimenLoader(self.pcapfilename, self.layer, relativeToIP=self.relativeToIP)
