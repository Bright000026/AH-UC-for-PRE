...
class FIELD:          # FIELD : [INTERVAL]
  ...
  def __eq__(self,other):
    if len(other.intervals) < len(self.intervals):
      return all([self.intervals[i] == other.intervals[i] for i in range(len(other.intervals))])
    return all([self.intervals[i] == other.intervals[i] for i in range(len(self.intervals))])

  def __lt__(self,other):
    if len(other.intervals) < len(self.intervals):
      return all([self.intervals[i].stop < other.intervals[i].start for i in range(len(other.intervals))])
    return all([self.intervals[i].stop < other.intervals[i].start for i in range(len(self.intervals))])

  def __xor__(self,other):
    if len(other.intervals) < len(self.intervals):
        return any([self.intervals[i] ^ other.intervals[i] for i in range(len(other.intervals))])
  ...
  def intersect(self,other):
    if len(other.intervals) < len(self.intervals):
         return (self ^ other) or (any([self.intervals[i].intersect( other.intervals[i]) for i in range(len(other.intervals))])) 
